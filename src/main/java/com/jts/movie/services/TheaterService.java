...
public class TheaterService {
	...
	public java.util.List<com.jts.movie.response.TheaterResponse> getAllTheaters() {
		return theaterRepository.findAll().stream().map(t -> com.jts.movie.response.TheaterResponse.builder()
				.id(t.getId())
				.name(t.getName())
